...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Prepara e vincula
    $ligar = $conectar->prepare("INSERT INTO bluray (Titulo, TipoConteudo, Genero, Elenco, Distribuidora, Produto, Diretor, AnoLancamento, Duracao, QuantidadeMidias) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
